...
$('.tab-container-gr4,.tab-container-gr5,.tab-container-gr6,.tab-container-ts').easytabs();

$(window).load(function() {
	$('.flexslider').flexslider({
		before: function() {
		$(".flex-active-slide").each(function(index, value) {
			var src = $(this).next('li').find('img').attr("data-original");
			var srcsnd = $(this).next('li').next('li').find('img').attr("data-original");
			$(this).next('li').find('img').attr("src", src);
			$(this).next('li').next('li').find('img').attr("src", srcsnd);
		});
		}
	});
});
jQuery('.etabs .tab a').click(function(event) {
	var id = $(this).attr('href');
	var ldr = $(id + ' ul li:first-child img').attr("data-original");
	$(id + ' ul li:first-child img').attr("src", ldr);
	//alert(id + 'ul li:first-child img');
});